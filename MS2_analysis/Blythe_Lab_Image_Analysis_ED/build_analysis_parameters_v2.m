...
% updated 08/23/18: filterFunction set to filterDOG2; turned script into 
% function to work with parB_analysis code

function parameters = build_analysis_parameters_v2(filename)
% clear
parameters = struct;
...
% Set a save directory for any output files.
parameters.saveDirectory = '/Users/ellie/Documents/MATLAB/Ellie/MS2_Gal4';
...
parameters.smoothSigma = 2; % standard: 2

% what is the 3D kernel for performing morphological opening? 
parameters.openSphereRad = 4; % standard: 4

% what is the minimum volume radius (in pixels) for an object that is to be kept?
parameters.lowerVolCutoffRad = 5; % standard: 5
 
% structuring element radius used in the h-minima transform
parameters.hMin = 0.5; % standard: 0.5
...
% (less stringent).
parameters.DoGsigma1 = 1; % standard: 1
parameters.DoGsigma2 = 2; % standard: 5

% what is the kernel for the contrast enhance function? 
parameters.contrastEnhanceSphereRad = 3; % standard: 3

% what are the minimum and maximum radii (in pixels) of ParB focal volumes?
parameters.minFocusVolRad = 1; % standard: 3
parameters.maxFocusVolRad = 100; % standard: 100

% what is the minimum number of Z-planes that a ParB focus must occupy in
% order for it to be kept?
parameters.minFocusPlaneOccupancy = 3; % standard: 3
...
parameters.excludeFociInPlane = 0; % standard: 0

% what is the upper p-value limit of focal intensity for which you would
% like to keep a focus?
parameters.focusIntensityPvalCutoff = 0.05; % standard: 0.05

% updated 9/5/18
parameters.minTotalIntensity = 100; % standard: 500
...
parameters.filterFunction = @filterDOG3;
