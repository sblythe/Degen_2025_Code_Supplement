function AP_meanFrac_SD = plotMeanFracActive_final(summaries,titleString)
    ...
    hold on;
    shadedErrorBar(AP_meanFrac_SD(:,1).*100,AP_meanFrac_SD(:,2),AP_meanFrac_SD(:,3),[100,149,237]./255,1,0.4) % corn flower blue: 100,149,237
    ylabel('Fraction of active nuclei','fontsize',8)
...
%     exportgraphics(f,strcat(savePath,'data_fractions_all.tif'),'Resolution',300,'BackgroundColor','white')
